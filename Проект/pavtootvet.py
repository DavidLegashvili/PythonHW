...
def avtootvet(help_input):
    ...
    if scd != -1:
        ...
        if trener.find("переч") != -1 or trener == "1":
            print("Наши тренеры:\nДавид Легашвили\nОлеся Савельева\nСавва Ларханиди")
        elif trener.find("данные") != -1 or trener == "2":
